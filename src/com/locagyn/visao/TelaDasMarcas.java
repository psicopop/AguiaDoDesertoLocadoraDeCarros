...
public class TelaDasMarcas extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel7LOGO.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                jLabel7LOGOMousePressed(evt);
            }
        });
    ...
    private void jButtonAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAlterarActionPerformed
        // TODO add your handling code here:
        try {
            Marca objeto = new Marca(Integer.parseInt(jTextFieldIdentificador.getText()) ,jTextFieldDescricao.getText().toUpperCase(),jTextFieldUrl.getText());
...
//        DefaultTableModel model = (DefaultTableModel)jTableMarcas.getModel();
//        int SelectedRowIndex = jTableMarcas.getSelectedRow();
//        String Id = model.getValueAt(SelectedRowIndex, 0).toString();
//        String Descricao = model.getValueAt(SelectedRowIndex, 1).toString();
//        String Url = model.getValueAt(SelectedRowIndex, 2).toString();
//        String NewDescricao = JOptionPane.showInputDialog(null,"Nova descrição",Descricao).toUpperCase();
//        model.setValueAt(NewDescricao, SelectedRowIndex, 1);
    ...
    private void jTableMarcasMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTableMarcasMouseClicked
        ...
        DefaultTableModel model = (DefaultTableModel)jTableMarcas.getModel();
        int SelectedRowIndex = jTableMarcas.getSelectedRow();
        jTextFieldIdentificador.setText(model.getValueAt(SelectedRowIndex, 0).toString());
        jTextFieldDescricao.setText(model.getValueAt(SelectedRowIndex, 1).toString());
        jTextFieldUrl.setText( model.getValueAt(SelectedRowIndex, 2).toString()); 
        
    }//GEN-LAST:event_jTableMarcasMouseClicked

    private void jLabel7LOGOMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel7LOGOMousePressed
        // TODO add your handling code here:
        DefaultTableModel model = (DefaultTableModel)jTableMarcas.getModel();
        int SelectedRowIndex = jTableMarcas.getSelectedRow();
        String jTextFieldIdentificador = model.getValueAt(SelectedRowIndex, 0).toString();
        String jTextFieldDescricao = model.getValueAt(SelectedRowIndex, 1).toString();
        String jTextFieldUrl = model.getValueAt(SelectedRowIndex, 2).toString();
    }//GEN-LAST:event_jLabel7LOGOMousePressed
